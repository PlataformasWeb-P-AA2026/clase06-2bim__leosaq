...
urlpatterns = [
    ...
    path(
        "editar_estudiante/<int:id>", views.editar_estudiante, name="editar_estudiante"
    ),
    path(
        "eliminar/estudiante/<int:id>",
    ...
    path(
        ...
        views.crear_numero_telefonico,
        name="crear_numero_telefonico",
    ),
    path(
        "editar/numero/telefonico/<int:id>",
        views.editar_numero_telefonico,
        name="editar_numero_telefonico",
    ),
    path(
        "crear/numero/telefonico/estudiante/<int:id>",
